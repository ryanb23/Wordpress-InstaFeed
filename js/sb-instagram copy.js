            ...
            jQuery('#sb_instagram.sbi').each(function(){ //Ends on line 1676
                ...
                function sbiCreateFeed(var_this,feedOptions) {
                    ...
                    jQuery.each( looparray, function( index, entry ) {
                        ...
                        if(getType == 'user'){
                            apiCall = "https://api.instagram.com/v1/users/"+ entry +"/media/recent?access_token=" + sb_instagram_js_options.sb_instagram_at+"&count=20";
                        } else if(getType == 'coordinates') {
                            ...
                            apiCall = "https://api.instagram.com/v1/media/search?lat="+lat+"&lng="+lng+"&distance="+dis+"&access_token=" + sb_instagram_js_options.sb_instagram_at+"&count=20&max_timestamp=";

                        } else if(getType == 'location') {
                            apiCall = "https://api.instagram.com/v1/locations/"+ entry +"/media/recent?access_token=" + sb_instagram_js_options.sb_instagram_at+"&count=20";
                        } else if(getType == 'liked') {
                            apiCall = "https://api.instagram.com/v1/users/self/media/liked?access_token=" + sb_instagram_js_options.sb_instagram_at+"&count=20";
                        } else if(getType == 'single') {
                            apiCall = "https://api.instagram.com/v1/media/"+ entry +"?access_token=" + sb_instagram_js_options.sb_instagram_at;
                        } else {
                            apiCall = "https://api.instagram.com/v1/tags/"+ entry +"/media/recent?access_token=" + sb_instagram_js_options.sb_instagram_at+"&count=20";
                        }
                    ...
                    if(sbiCacheExists == 'true' && !feedOptions.disablecache){
                        ...
                        sbiSetUserApiUrl(ids_arr[0], sb_instagram_js_options.sb_instagram_at, '/media/recent', '&count=20', function(apiURL){
...
/*
                            ...
                            var keyword_contains = ' ';var keyword_contains_list = '';
                            jQuery.each( sb_instagram_keywords, function( index, keyword ) {
                                keyword = jQuery.trim(keyword).toLowerCase();
                                if( item.caption != null && item.caption.text.toLowerCase().indexOf(keyword) > -1 && keyword !== '' ){
                                    //keyword_contains = ' keywords_in ';
                                    //return false;
                                    keyword_contains_list += keyword + ',';
                                }
                            });
                        ...
                        function sbiAfterImagesLoaded(){
                            ...
                            */
                            /*
                            $self.find('#sbi_images .sbi_item.sbi_new').appendTo($self.find('#sbi_images'));
*/
                            ...
                            //implement sort on ALL divs including the pevious ones.
                    ...
                    function sbiBuildHeader(data, sbiSettings){
                        ...
                        $header = '<h3 style="float:right;margin-top:20px;font-size:22px;"> RANK #'+sbiSettings.rank+' </h3>';
                        ...
                        $headerInfo += '><span class="sbi_followers">FOLLOWERS : '+kFormatter(data.data.counts.followed_by)+'</span><span> | </span><span class="sbi_posts_count">SATURACIÓN : '+sbiSettings.percentage+'%</span><span> | </span><span class="sbi_followers">ÍNDICE (MARCAS) : '+sbiSettings.marcas+' Likes/Post</span><span> | </span><span class="sbi_followers">ÍNDICE (TODOS) : '+sbiSettings.todos+' Likes/Post</span></p>';

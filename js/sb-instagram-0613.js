...
if(!sbi_js_exists){
    ...
    var post_style_info = {};
    var post_style_global = {users:0,posts:0,likes:0,reps:0,views:0};
    var post_style_influencer_info={};
    var post_style_influencer_global={brands:0,posts:0,likes:0,reps:0,views:0};
                            ...
                            */
                            ...
                            if(post_style == 'product')
                            {
                                ...
                                if(tmp_post_array[item.user.id].hasOwnProperty(parseInt(created_time_fixed / 86400) * 86400)) {
                                    ...
                                    tmp_post_array[item.user.id][parseInt(created_time_fixed / 86400) * 86400] = {created_time:parseInt(created_time_fixed /  86400) * 86400,likes:item.likes.count,username:item.user.username,post_count:1,media_ids:[item.id]};
                                ...
                                if(post_style_info.hasOwnProperty(item.user.id))
                                {
                                    ...
                                    post_style_info[item.user.id] = {username:username_org,likes:item.likes.count,posts:1};
                                }
...
//                                tmp_post_array[keyword_influencer][parseInt(created_time_fixed / 86400) * 86400] = {created_time:parseInt(created_time_fixed /  86400) * 86400,likes:item.likes.count};
                                ...
                                if(tmp_post_array[keyword_influencer].hasOwnProperty(parseInt(created_time_fixed / 86400) * 86400))
                                {
                                    ...
                                    tmp_post_array[keyword_influencer][parseInt(created_time_fixed / 86400) * 86400] = {created_time:parseInt(created_time_fixed /  86400) * 86400,likes:item.likes.count,post_count:1,media_ids:[item.id]};
                        ...
                        function sbiAfterImagesLoaded(){
                            ...
                            if(post_style == 'product') {
                                ...
                                function sbi_generate_post_header(avatar,profile_username, followed_by)
                                {
                                    ...
                                    post_style_header += '<h3 style="text-align:center;font-size:26px;fone-weight:700">' +feedOptions.sbiHeaderTitle+' </h3><h3 style="text-align: center;" ><span class="jq-dropdown-span" data-jq-dropdown="#jq-dropdown-users">' + post_style_global['users'] + ' '+feedOptions.sbiKeywordType +'</span><span id="dropdown_posts">' + post_style_global['posts'] + '</span> Posts<span id="dropdown_likes">' + commaSeparateNumber(post_style_global['likes']) + '</span> Likes '+ viewCoutnHtml +'</h3><div id="myChart_wrapper_div" style="width:100%;margin:auto;"><canvas id="myChart"></canvas></div><h3 style="text-align:center;font-weight:bold;">RENDIMIENTO (LIKES/POST)</h3><h5 id="dropdown_statistics" style="text-align:center;">';
                                    ...
                                    var sorted=[];
                                    for(i=0;i<len;i++)
                                        sorted.push([post_style_info[keys[i]]['username'],post_style_info[keys[i]]['likes']/post_style_info[keys[i]]['posts'],keys[i]]);
                                    sorted.sort(function(a,b){return b[1] - a[1]});
                                    var dropdown_div ='<div id="jq-dropdown-users" class="jq-dropdown jq-dropdown-tip"><ul class="jq-dropdown-menu"><li><a class="jquery-dropdown-item" href="#" data-user-name="" data-user-id="">'+post_style_global['users'] + ' '+feedOptions.sbiKeywordType +'</a></li>';
                                    for(i=0;i<len;i++){
                                        //add usernames and posts of users
                                        post_style_header += '<strong>' + sorted[i][0] + '</strong>: ' + kFormatter(sorted[i][1]) +  ' | ';

                                        //now add usernames to dropdown
                                        dropdown_div += '<li><a class="jquery-dropdown-item" href="#" data-user-name="'+sorted[i][0].toLowerCase()+'" data-user-id="'+sorted[i][2]+'">'+sorted[i][0]+'</a></li>';
                                    }
                                    dropdown_div += '</ul></div>';
/*
                                    for (i = 0; i < len; i++) {
                                    ...
                                    */
                                    ...
                                    jQuery('#sb_instagram').append(dropdown_div).find('.jquery-dropdown-item')
                                        .on('click', function() {
                                            ...
                                            jQuery('.jq-dropdown-span').html(jQuery(this).html());
                                            ...
                                            if(dd_user_name != '') {
                                                ...
                                                jQuery('#dropdown_likes').html(post_style_info[dd_user_id]['likes']);
                                                jQuery('#dropdown_statistics').html('<strong>'+dd_user_name+'</strong>: '+kFormatter(post_style_info[dd_user_id]['likes']/post_style_info[dd_user_id]['posts']));
                                                ...
                                                jQuery('#dropdown_likes').html(post_style_global['likes']);
                                                var keys = Object.keys(post_style_info),
                                                    i, len = keys.length;
                                                var sorted=[];
                                                for(i=0;i<len;i++)
                                    ...
                                    function draw_chart(dd_user_id ) {
                                        ...
                                        for (var user_id in tmp_post_array) {
                                            ...
                                            for (var created_time in item) {
                                                tmp_datasets[user_id][parseInt(item[created_time].created_time)] += item[created_time].likes;
                            ...
                            if(post_style == 'product_influencer'){
                                ...
                                function sbi_generate_post_header(avatar,profile_username,followed_by)
                                {
                                    ...
                                    post_style_influencer_header += '<h3 style="text-align:center;font-size:26px;">' +feedOptions.sbiHeaderTitle+' </h3>                               <h3 style="text-align: center;"><span class="jq-dropdown-span" data-jq-dropdown="#jq-dropdown-users">' + post_style_influencer_global['brands'] + ' '+feedOptions.sbiKeywordType +'</span><span id="dropdown_posts">' + post_style_influencer_global['posts'] + '</span> Posts<span id="dropdown_likes">' + commaSeparateNumber(post_style_influencer_global['likes']) + '</span> Likes'+viewCoutnHtml+'</h3><div id="myChart_wrapper_div" style="width:100%;margin:auto;"><canvas id="myChart"></canvas></div></div><h3 style="text-align:center;">RENDIMIENTO (LIKES/POST)</h3><h5 id="dropdown_statistics" style="text-align:center;">';
                                    ...
                                    var sorted=[];
                                    for(i=0;i<len;i++)
                                        sorted.push([keys[i],post_style_influencer_info[keys[i]]['likes']/post_style_influencer_info[keys[i]]['posts'],post_style_influencer_info[keys[i]]['keyword_origin']]);
                                    sorted.sort(function(a,b){return b[1] - a[1]});

                                    //make dropdown
                                    var dropdown_div ='<div id="jq-dropdown-users" class="jq-dropdown jq-dropdown-tip"><ul class="jq-dropdown-menu"><li><a class="jquery-dropdown-item" href="#" data-user-name="" data-user-id="">'+post_style_influencer_global['brands'] +' '+feedOptions.sbiKeywordType+'</a></li>';

                                    for(i=0;i<len;i++){
                                        post_style_influencer_header += '<strong>' + sorted[i][0] + '</strong>: ' + kFormatter(sorted[i][1]) +  ' | ';
                                        //now add usernames to dropdown
                                        dropdown_div += '<li><a class="jquery-dropdown-item" href="#" data-user-name-origin = "'+sorted[i][2]+'" data-user-name="'+sorted[i][0].toLowerCase()+'" data-user-id="'+sorted[i][0]+'">'+sorted[i][2]+'</a></li>';
                                    }
                                    dropdown_div += '</ul></div>';
                                    ...
                                    jQuery('#sb_instagram').append(dropdown_div).find('.jquery-dropdown-item')
                                        .on('click', function() {
                                            ...
                                            if(dd_user_name != '') {
                                                ...
                                                jQuery('#dropdown_likes').html(post_style_influencer_info[dd_user_id]['likes']);
                                                jQuery('#dropdown_statistics').html('<strong>'+dd_user_name+'</strong>: '+kFormatter(post_style_influencer_info[dd_user_id]['likes']/post_style_influencer_info[dd_user_id]['posts']));
                                                ...
                                                jQuery('#dropdown_likes').html(post_style_influencer_global['likes']);
                                                var keys = Object.keys(post_style_influencer_info),
                                                    i, len = keys.length;
                                                var sorted=[];
                                                for(i=0;i<len;i++)
                                                    sorted.push([keys[i],post_style_influencer_info[keys[i]]['likes']/post_style_influencer_info[keys[i]]['posts'],keys[i]]);
                                                sorted.sort(function(a,b){return b[1] - a[1]});
                                    ...
                                    function draw_chart_i(dd_user_id ) {
                                        ...
                                        for (var keyword_influencer in tmp_post_array) {
                                            ...
                                            for (var created_time in item) {
                                                tmp_datasets[keyword_influencer][parseInt(item[created_time].created_time)] += item[created_time].likes;
...
/** New **/
                        ...
                        $headerInfo += '><span class="sbi_followers" title="Interacciones por post promedio">ÍNDICE : '+kFormatter(sbiSettings.todos)+' Likes/Post</span><span> | </span><span title="Número actual de seguidores" class="sbi_followers">FOLLOWERS : <b>'+kFormatter(data.data.counts.followed_by)+'</b></span></p>';

                        if(sbiShowHighlight)
                            $headerInfo += '<p class="sbi_bio_info1"><span title="Porcentaje de posts donde mencionan marcas" class="sbi_posts_count"><span class="full_view">POSTS DE </span>MARCAS : <b>'+kFormatter(sbiSettings.percentage)+'%</b></span><span> | </span><span title="Interacciones por post promedio donde mencionan marcas" class="sbi_followers">ÍNDICE<span class="full_view"> DE MARCAS</span> : <b>'+kFormatter(sbiSettings.marcas)+' Likes/Post</></span><span class="marcas_icon"><i class="fa fa-file-image-o" aria-hidden="true"></i></span></p>';
                        $headerInfo += '</div>';
                        if(feedOptions.showfollowers != '' && feedOptions.showfollowers != 'false' && feedOptions.headerstyle !== 'boxed') $header += $headerInfo;
                            ...
                            function sbiImagesReady(getType,has_to_sort ){
                                ...
                                if(sortby == 'most-liked')
                                {
                                    ...
                                    returnedImagesArr.sort(function(x, y){
                                        return y.likes.count - x.likes.count;
                                    });
                                    //console.log(returnedImagesArr);
                                }
                                else if(sortby == 'least-liked') {
                                    returnedImagesArr.sort(function(x, y){
                                        return x.likes.count - y.likes.count;
                                    });
                                }
